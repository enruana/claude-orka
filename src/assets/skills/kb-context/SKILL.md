---
name: kb-context
description: Load the project's Knowledge Base context — decisions, open questions, active work items, milestones, recent activity. Use before answering repo-wide questions or making architectural decisions.
---
