---
name: kb-lint
description: Audit the KB for health issues — missing sources, off-spec statuses, deprecated relations, missing recommended properties. Use when the user asks to check, audit, or clean up the KB.
---
