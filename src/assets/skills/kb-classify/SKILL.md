---
name: kb-classify
description: Detect the correct KB tier (goal/initiative/project/task/spike/bug) for a work item. Use when a v1 project entity might actually be a task/bug/spike, or when classifying newly captured work before adding it.
---
