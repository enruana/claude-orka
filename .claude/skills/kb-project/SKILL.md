---
name: kb-project
description: Manage work-tier entities (goal, initiative, project, task, spike, bug). Pick the right tier when creating or updating work items. Use before adding project/task-like entities.
---
