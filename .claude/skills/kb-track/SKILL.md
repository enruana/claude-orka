---
name: kb-track
description: Capture decisions, questions, work items, milestones, people, or direction changes from the current conversation into the KB. Use whenever the user makes a decision, opens a question, or names a task worth remembering.
---
